...
def main(args):
    ...
    classifier_filename_exp="/home/guttappa/Desktop/FaceGen_project/facenet/src/models/my_classifier_25.pkl"
    ...
    data_dir="/home/guttappa/Desktop/FaceGen_project/facenet/src/align/aligned_faces"
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            # Load the model
            facenet.load_model(classifier_filename_exp)
            ...
            print('Begin to capture video from ' + 1)
            video_capture = cv2.VideoCapture(0)

            if not video_capture.isOpened(): 
                print ('Can not open the video from ' + 1)
                sys.exit()           
